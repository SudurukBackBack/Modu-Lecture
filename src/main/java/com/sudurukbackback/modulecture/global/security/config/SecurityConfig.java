    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/sign-up", "/auth/sign-in", "/main", "/css/**", "/js/**", "/images/**", "/fragments/**", "/mypage/**", "/mypage-tutor-upload/**", "/mypage-tutor", "/mypage-tutor-update", "/mypage-lecture", "/mypage-account").permitAll() // 인증 없이 접근 가능
